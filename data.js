...
(function (global) {
  ...
  /* ===================== 10/9（金）発 ===================== */
  {
    ...
    pros:[
      '5日程で<strong>最安</strong>。1泊目が金曜泊なのがそのまま効いています。',
  ...
  /* ===================== 10/10（土）発 ===================== */
  {
    ...
    pros:[
      ...
      '5日程で唯一、<strong>実際に空室と価格を確認済み</strong>の確定数字です。'
    ],
    cons:[
      '5日程で<strong>最も高い</strong>（1泊目が土曜泊、2泊目が連休中日）。',
  ...
  /* ===================== 10/16（金）発 ===================== */
  {
    ...
    availabilityNote:'3連休を外した通常週末なので、<strong>ねむりんの禁煙室やコテージも選べる可能性が高い</strong>日程です。5日程のなかで最も部屋の選択肢が広いと見込まれます。',
    foliage:'ロープウェイ山麓駅〜大丸温泉（標高1,300m前後）が見頃。ドライブしながら紅葉のグラデーションを楽しめる時期です。',
    pros:[
      '<strong>混雑と価格のバランスが最良</strong>。連休を外した通常週末なので、どの施設も待ち時間が短くて済みます。',
      'ねむりんの<strong>部屋を選べる</strong>可能性が最も高い日程（禁煙室・コテージ）。',
    ...
    verdict:'「安さ・空き・空いている・紅葉」の総合点では、この日程が一番バランスが取れています。'
  },
  ...
  /* ===================== 10/23（金）発 ===================== */
  {
    ...
    cons:[
      '5日程で<strong>宿代が最も高い</strong>（紅葉ハイシーズン料金）。',
